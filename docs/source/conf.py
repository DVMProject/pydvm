...
project = "pydvm"
copyright = f"{date.today().year}, W3AXL"
author = "W3AXL"
...
# LinkCode
code_url = f"https://github.com/DVMProject/pydvm/blob/{git_commit}"
